...
const Aliados = () => {
	return (
		<div style={{
			...
			<p style={{ maxWidth: '75vw', margin: '0 auto 5rem', fontSize: '1.30rem', textAlign: 'center' }}>
				La Asociación de Béisbol Menor Pilotos de Honduras (FAH) cuenta con más de 76 años 
				de historia desde su formación en 1948. Nuestro principal objetivo es la formación 
				integral de jovenes atletas, no solo en el juego del béisbol, sino también en la 
				generación de líderes y ciudadanos de sus comunidades y país.
			</p>
...
>
  ...
  <div style={{ flex: 1 }}>
    ...
    />
    <p style={{ fontSize: '1.3rem', marginBottom: '1rem', textAlign: 'left', maxWidth:'50vw' }}>
