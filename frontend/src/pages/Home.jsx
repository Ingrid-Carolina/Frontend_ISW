...
const Cards = () => (
	<div className='cards'>
		<MediaCard
			title='Embajadores Fundación Angelitos'
    ...
    Nos honra compartirles que somos Embajadores de la Fundación Angelitos - Recién Nacidos del Hospital Escuela, y llevaremos su mensaje con orgullo dentro y fuera del campo.'
		...
		/>
		<MediaCard
			title='Torneo LBMM 2025:  ¡Nuestros Pilotos Dejarán Huella en el Torneo LBMM 2025!'
	...
	return (
		<div style={{ paddingTop: '90px' }}>
			...
			<div style={{ textAlign: 'center', margin: '2rem 0 4rem' }}>
				<button className='news-button'>Más Noticias</button>
			</div>
		</div>
	);
}
