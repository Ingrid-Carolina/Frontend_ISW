...
const PaginaTestimonios = () => {
	...
	useEffect(() => {
		const fetchImages = async () => {
			try {
				...
				console.error(
					'Error al cargar la imagen de encabezado de testimonios:',
					error,
				);
	...
	const handleImageChange = async file => {
		try {
			...
			console.log(
				`Imagen de testimonios_header guardada y actualizada exitosamente.`,
			);
		} catch (error) {
			console.error(
				`Error al actualizar la imagen de testimonios_header:`,
				error,
			);
